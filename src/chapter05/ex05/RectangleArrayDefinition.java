...
public class RectangleArrayDefinition {
	...
	public static void main(String[] args) {
		...
		//	- 비정방형 배열		: row(행)에 대해서 열이 동일하지 않는 배열
		...
		//4. 정방형 배열 선언과 동시에 값넣기1 : <주의!> 방크기를 지정하면 오류 발생
		System.out.println("=========================");
		...
		arr12 = new int[][] {{11,12,13,14},{21,22,23,24},{31,32,33,34}};
	                        	//뒤에 {}가 앞에 {}밑으로간다고 생각
		System.out.println(arr12[2][3]);
		
		//5. 정방형 배열 선언과 동시에 값 넣기2 : ! 선언과 값을 분리 할 수 없다.
		int[][] arr13 = {{100,110,120},{210,220,230}};
		
		//선언과 값을 분리해서 넣을 수 없다.
		int[][] arr14;
//		arr14 = {{1,2,3},{4,5,6}}; !오류발생
		arr14 = new int[][] {{1,2,3},{4,5,6}};//new int를 넣어야한다
