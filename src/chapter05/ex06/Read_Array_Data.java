...
public class Read_Array_Data {
	...
	public static void main(String[] args) {
		...
		System.out.println(arr1.length); //=300	/방의 갯수(열의 갯수)
		...
		System.out.println(arr2[0].length);//=5(0번 행의 열의 갯수)
		System.out.println(arr2[1].length);//=5(1번 행의 열의 갯수)
		...
		for(int i = 0; i < arr3.length; i++) {	//i:행의 인덱스(방)번호 /arr3.length:행의 갯수
			//바깥쪽 for문:행의 정보를 출력
			for (int j = 0; j<arr3[i].length ; j++) {	//j:열의 방번호/arr3[i].length:i행의 열의 갯수
				//안쪽 for문은 열의 정보를 출력
